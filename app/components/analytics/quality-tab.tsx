  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
        <StatCard label="Total Calls" value={String(data.totalCalls)} size="hero" />
        ...
        <StatCard
          ...
          color={
            toolFailureRate != null
              ? inverseRateColor(Number(toolFailureRate), 0, 5)
              : undefined
          }
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 gap-6">
        <InterruptionRateTrendChart
          data={data.interruptionRateTrendData}
