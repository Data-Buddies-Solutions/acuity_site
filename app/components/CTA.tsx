...
export default function CTA() {
  return (
    <section
      className="py-20 md:py-32 bg-white relative overflow-hidden border-t border-neutral-100"
      id="contact"
    >
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="text-base md:text-lg text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
          Book a 30-minute demo. We&apos;ll run a live call using your scheduling rules,
          insurance requirements, and appointment types.
        </p>
